...
function generate_slider_items($category, $max, $current_parts) {
    ...
    for ($i = 1; $i <= $max; $i++) {
        ...
        $fileName = urlencode("{$CategoryName} {$i}.png"); 
        
        $output .= "<a href='index.php?{$query_string}' class='slider-item {$active_class}'>";
        $output .= "<img src='assets/{$CategoryName}/{$fileName}' alt='{$CategoryName} {$i}'>";
        $output .= "</a>";
    }
    return $output;
}
            ...
            <div id="avatar-frame">
                <div id="avatar-layers">
                    ...
                    <img id="badan-part" class="avatar-layer" style="z-index: 10;" 
                        src="assets/badan/Badan%20<?php echo $current['badan']; ?>.png" alt="Badan">
                    
                    <img id="baju-part" class="avatar-layer" style="z-index: 15;" 
                        src="assets/baju/Baju%20<?php echo $current['baju']; ?>.png" alt="Baju">
                    
                    <img id="mata-part" class="avatar-layer" style="z-index: 25;" 
                        src="assets/mata/Mata%20<?php echo $current['mata']; ?>.png" alt="Mata">
                    
                    <img id="mulut-part" class="avatar-layer" style="z-index: 30;" 
                        src="assets/mulut/Mulut%20<?php echo $current['mulut']; ?>.png" alt="Mulut">
                    
                    <img id="kepala-part" class="avatar-layer" style="z-index: 35;" 
                        src="assets/kepala/Kepala%20<?php echo $current['kepala']; ?>.png" alt="Kepala">
                        
                    <img id="display-frame" class="avatar-layer" style="z-index: 99;" 
                         src="assets/.Frame.png" alt="Frame Display" 
